...
import { AmocaArciumProjectCypherpunk } from "../target/types/amoca_arcium_project_cypherpunk";
...
describe("AmocaArciumProjectCypherpunk", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .AmocaArciumProjectCypherpunk as Program<AmocaArciumProjectCypherpunk>;
  ...
  async function initAddTogetherCompDef(
    program: Program<AmocaArciumProjectCypherpunk>,
